export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center rounded-md">
      <h1 className="text-4xl font-bold mb-4">Dev Tool Chest</h1>
      <p className="text-lg text-muted-foreground max-w-xl mb-6">
        Welcome to <span className="font-semibold">Dev Tool Chest</span>!<br />
      ...
      <ul className="text-left mx-auto max-w-md list-disc list-inside text-muted-foreground">
